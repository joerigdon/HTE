...
true = read.csv('/Users/jrigdon/Box Sync/Rigdon/Sanjay/HTE/DATA2A.csv', header=TRUE, colClasses=c("numeric", "factor", rep("numeric", 4), rep("factor", 2), "numeric", rep("factor", 4), "character"))
...
prop.test(x=c(157, 203), n=c(3000, 3000))
...
pdf("/Users/jrigdon/Box sync/Rigdon/Sanjay/HTE/LR_2A.pdf")
...
pdf("/Users/jrigdon/Box sync/Rigdon/Sanjay/HTE/GRF_2A.pdf")
...
pdf("/Users/jrigdon/Box sync/Rigdon/Sanjay/HTE/RF_2A.pdf")
plot(fitRF, type="simple") #2 terminal nodes
dev.off()

pdf("/Users/jrigdon/Box sync/Rigdon/Sanjay/HTE/mCART_2A.pdf")
...
length(table(true$nodeLR1)) #448
#length(table(true$nodeLR2)) #1
length(table(true$nodeRF)) #2
length(table(true$nodeGRF1)) #24
...
pdf("/Users/jrigdon/Box sync/Rigdon/Sanjay/HTE/Plot_TE_ASD_2A.pdf")
...
##Save tables
word.doc(obj.list=list(tt1, tt2, tt3, tt4), obj.title=c('Table 1: mCART', 'Table 2: LR', 'Table 3: RF', 'Table 4: GRF'), dest='/Users/jrigdon/Box sync/Rigdon/Sanjay/HTE/Tab_HTE_2A.docx', ftype='Arial', col.odd='white')
